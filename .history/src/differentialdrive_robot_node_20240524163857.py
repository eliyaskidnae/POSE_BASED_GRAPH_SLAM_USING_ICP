...
class DifferentialDrive:
    def __init__(self) -> None:
        ...
        self.max_scan_history = 7 # maximum amount of scan history to store 
        self.num_of_scans_to_remove = 3 # number of scans to remove from the history
    ...
    def check_scan(self, scan):
        ...
        if(len(self.map) == 0 and len(self.scan_cartesian)):
            ...
            Ho = self.pse.OverlappingScan(self.xk , self.overlapping_check_th_dis , )            
