...
class DifferentialDrive:
    def __init__(self) -> None:
        ...
        self.pse = PoseSLAMEKF(self.xk, self.Pk, self.Qk, self.wheel_base , self.wheel_radius ,self.compass_Rk , self.compass_Vk , self.overlapping_check_th_dis)
    ...
    def heading_update(self):
        ...
        self.xk_imu = self.xk[-3:].reshape(3,1) 


        self.XK_DR = self.XK_DR + K@innovation
        self.PK_DR = (I - K @ Hk) @ self.PK_DR @ (I - K @ Hk).T
        self.xk_dr = self.XK_DR[-3:].reshape(3,1)
