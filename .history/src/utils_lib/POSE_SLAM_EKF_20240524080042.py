...
class PoseSLAMEKF:
    ...
    def OverlappingScan(self, xk ):
        ...
        return H0
    def remove_pose(self, xk , Pk , len):
        '''
        This function takes in the state vector and covariance matrix and removes the last pose from the state vector and covariance matrix.
        Inputs:
        - xk: The state vector
        - Pk: The covariance matrix
        Outputs:
